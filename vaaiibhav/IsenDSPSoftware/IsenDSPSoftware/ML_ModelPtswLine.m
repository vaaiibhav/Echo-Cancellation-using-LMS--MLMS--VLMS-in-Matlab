function ML_ModelPtswLine(TestM,TestYInt,xTest,Mu0,yMu2MuRatio,MStart,yIntStart,NoIts)
%function ML_ModelPtswLine(TestM,TestYInt,xTest,Mu0,yMu2MuRatio,MStart,yIntStart,NoIts)
%
...
% 
% Sample calls:
% ML_ModelPtswLine(2,0,[-10:1:10],0.014,37,-10,8,12) % fast convergence
% ML_ModelPtswLine(2,0,[-10:1:10],0.005,1,-10,8,40) % sharp turn in gradient search
% ML_ModelPtswLine(2,0,[-10:1:10],0.025,1,-10,8,60) % overshoot on slope
% ML_ModelPtswLine(2,0,[-10:1:10],0.025,40,-10,8,30) % overshoot both slope & yInt
% ML_ModelPtswLine(20,-90,[-10:1:10],0.005,10,-10,8,40)
% ML_ModelPtswLine(2,0,[0:1:10],0.01,50,-10,8,80); 
% ML_ModelPtswLine(1,-2,[0:1:10],0.01,50,-10,8,80);
%
% Author: F. W. Isen
...
xlabel(['y-Intercept'],'fontsize',ftsz1)
ylabel(['Slope'],'fontsize',ftsz1)
zlabel(['MSE'],'fontsize',ftsz1)
...
hold on
plot3(yIntNow,SlopeNow,thisMSE,'wo')
set(gca,'fontsize',16')
