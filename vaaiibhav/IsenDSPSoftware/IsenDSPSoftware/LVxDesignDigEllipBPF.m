function [b,a,G,NetRp,NetAs] = LVxDesignDigEllipBPF(Rp,As,ws1,wp1,wp2,ws2)
...
% a (denominator) coefficients of a digital Elliptic BPF along with filter
% gain G and the realized values of Rp (NetRp) and As (NetAs).
% Sample calls:
% [b,a,G,NetRp,NetAs] = LVxDesignDigEllipBPF(1,45,0.4,0.475,0.65,0.775)
% [b,a,G,NetRp,NetAs] = LVxDesignDigEllipBPF(1,60,0.45,0.55,0.7,0.83)
% [b,a,G,NetRp,NetAs] = LVxDesignDigEllipBPF(1,75,0.4,0.475,0.65,0.775)
% [b,a,G,NetRp,NetAs] = LVxDesignDigEllipBPF(1,75,0.1,0.12,0.4,0.5)
%
% Author: F. W. Isen
...
[Z,P,K] = LVxDesignAnalogEllipBPF(OmS1,OmP1,OmP2,OmS2,Rp,As);
NumPoles = length(P);
NumZeros = length(Z);
