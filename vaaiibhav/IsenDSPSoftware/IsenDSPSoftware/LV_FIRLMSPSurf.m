function LV_FIRLMSPSurf(PC1,PC2,Mu,c1St,c2St,NoIts,tstDType, CosFrq, NoiseAmp)
% function LV_FIRLMSPSurf(PC1,PC2,Mu,c1St,c2St,NoIts,tstDType,CosFrq)
%
...
% sine wave.  
% CosFrq is the frequency for the test sine wave (pass as []
% if a cosine wave is not being used as a test signal). 
% Typical calls are:
% LV_FIRLMSPSurf(3,2,0.25,0,0,6,1,[],0)
% LV_FIRLMSPSurf(1,-0.5,0.35,0,-0.2,12,0,[],0)
% LV_FIRLMSPSurf(1,-0.5,0.35,4,-5,6,3,[],0)   
% LV_FIRLMSPSurf(-1,3,0.25,5,-4,12,4,25,0)
% LV_FIRLMSPSurf(-1,3,0.5,5,-4,6,4,[155],0)
%
% Author: F. W. Isen
